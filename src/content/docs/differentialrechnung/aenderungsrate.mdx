...
**Aufgabe 1** (⭐) Berechne die mittlere Änderungsrate von $f(x) = x^2$
auf $[1;\ 3]$.
...
**Aufgabe 2** (⭐) Begründe: Die mittlere Änderungsrate von
...
**Aufgabe 3** (⭐) Radtour: $s(0) = 0$, $s(1) = 12$, $s(2) = 20$,
...
**Aufgabe 4** (⭐) Berechne die mittlere Änderungsrate von
...
**Aufgabe 5** (⭐⭐) Berechne die mittlere Änderungsrate von $f(x) = x^3$
auf $[1;\ 2]$.
...
**Aufgabe 6** (⭐⭐) $f(x) = 0{,}5x^2 + 1$ (Graph mit Steigungsdreieck in
...
**Aufgabe 7** (⭐⭐) Sprintmodell $s(t) = 1{,}5t^2$: Berechne die mittlere
...
**Aufgabe 8** (⭐⭐) $f(x) = x^2$, Stelle $a = 1$. Berechne die
...
**Aufgabe 9** (⭐⭐) $f(x) = x^2 + 1$. Vereinfache den
...
**Aufgabe 10** (⭐⭐) Auf der Autobahn: Ein Streckenradar misst die Zeit
...
**Aufgabe 11** (⭐⭐) Wirkstoffmodell $K(t) = -0{,}1t^2 + 2{,}4t$
...
**Aufgabe 12** (⭐⭐) An welcher Stelle ist die **lokale** Änderungsrate
...
**Aufgabe 13** (⭐⭐⭐) $f(x) = x^3$, Stelle $a = 1$. Berechne die
...
**Aufgabe 14** (⭐⭐⭐) Der Temperaturverlauf eines Tages sei
...
**Aufgabe 15** (⭐⭐) $f(x) = x^2$. Gib ohne Rechnung an, für welche
...
**Aufgabe 16** (⭐⭐⭐) Modellkritik: Das Sprintmodell $s(t) = 1{,}5t^2$
