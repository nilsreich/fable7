...
**Aufgabe 1** (⭐) Leite ab: a) $x^4$  b) $x^7$  c) $x^{100}$
...
**Aufgabe 2** (⭐) Leite ab: a) $3x^2$  b) $-5x^4$  c) $\frac{1}{2}x^3$
...
**Aufgabe 3** (⭐) Leite ab: a) $f(x) = x^2 + x$  b) $g(x) = x^3 - 2x + 5$
...
**Aufgabe 4** (⭐) Leite ab: $f(x) = 2x^3 - 4x^2 + x - 8$
...
**Aufgabe 5** (⭐) Leite ab: a) $f(x) = 9$  b) $g(x) = x + 9$
...
**Aufgabe 6** (⭐⭐) Leite ab: $f(x) = -0{,}5x^4 + 2x^2 - 3$
...
**Aufgabe 8** (⭐⭐) An welcher Stelle hat der Graph von
...
**Aufgabe 9** (⭐⭐) $f(x) = x^4 - 2x^3$. Bestimme $f'$, $f''$ und $f'''$.
...
**Aufgabe 10** (⭐⭐) $f(x) = 0{,}5x^4 - x^2$. Berechne die
...
**Aufgabe 11** (⭐⭐) In welchem Punkt hat die Normalparabel
...
**Aufgabe 12** (⭐⭐) Schreibe als Potenz und leite ab:
...
**Aufgabe 13** (⭐⭐) Leite ab (erst umformen!):
...
**Aufgabe 14** (⭐⭐⭐) Für welchen Wert von $a$ hat der Graph von
...
**Aufgabe 15** (⭐⭐⭐) Sprintmodell $s(t) = 1{,}5t^2$.
...
**Aufgabe 16** (⭐⭐⭐) Zeige: Der Graph von $f(x) = x^3$ hat an keiner
