...
**Aufgabe 1** (⭐) $f(x) = x^2$. Stelle den Differenzenquotienten an der
...
**Aufgabe 2** (⭐) Berechne mit der h-Methode $f'(2)$ für $f(x) = x^2$.
...
**Aufgabe 3** (⭐) Berechne mit der h-Methode $f'(-1)$ für $f(x) = x^2$.
...
**Aufgabe 4** (⭐) Was bedeutet das Ergebnis $f'(3) = 6$ aus Aufgabe 1
...
**Aufgabe 5** (⭐⭐) Bestimme mit der h-Methode die Ableitungsfunktion von
...
**Aufgabe 6** (⭐⭐) Bestimme mit der h-Methode die Ableitungsfunktion von
$f(x) = 2x^2$.
...
**Aufgabe 7** (⭐⭐) Berechne mit der h-Methode $f'(1)$ für $f(x) = x^3$.
...
**Aufgabe 8** (⭐⭐) Berechne mit der h-Methode $f'(2)$ für $f(x) = x^3$.
...
**Aufgabe 9** (⭐⭐) Bestimme mit der h-Methode die Ableitung von
...
**Aufgabe 10** (⭐⭐) Bestimme mit der h-Methode die Ableitung einer
...
**Aufgabe 11** (⭐⭐) $f(x) = x^2 - 4x$. Bestimme mit der h-Methode die
...
**Aufgabe 12** (⭐⭐) Für $f(x) = x^2$ gilt $f'(x) = 2x$.
...
**Aufgabe 13** (⭐⭐⭐) Berechne mit der h-Methode $f'(2)$ für
$f(x) = \dfrac{1}{x}$.
...
**Aufgabe 14** (⭐⭐⭐) Bestimme mit der h-Methode die Ableitungsfunktion
von $f(x) = x^3 - x$.
...
**Aufgabe 15** (⭐⭐) Fehlersuche! Ein Schüler rechnet für $f(x) = x^2$:
...
**Aufgabe 16** (⭐⭐⭐) Sprintmodell $s(t) = 1{,}5t^2$ (vorige Seite).
