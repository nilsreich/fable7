...
**Aufgabe 1** (⭐) Vervollständige das „Wörterbuch“: Was gilt am
...
**Aufgabe 2** (⭐) Der Graph von $f$ hat einen Hochpunkt bei $x = -1$ und
...
**Aufgabe 3** (⭐) Skizziere den Graphen von $f'$ zum abgebildeten
Graphen:
...
**Aufgabe 4** (⭐) Skizziere den Graphen von $f'$:
...
**Aufgabe 5** (⭐⭐) Skizziere den Graphen von $f'$:
...
**Aufgabe 6** (⭐⭐) Skizziere den Graphen von $f'$:
...
**Aufgabe 7** (⭐⭐⭐) Skizziere den Graphen von $f'$:
...
**Aufgabe 8** (⭐⭐) Diesmal umgekehrt – gegeben ist der Graph der
...
**Aufgabe 9** (⭐⭐) Warum ist der Graph von $f$ in Aufgabe 8 nicht
...
**Aufgabe 10** (⭐⭐) Woran erkennt man am $f'$-Graphen, dass $f$ einen
...
**Aufgabe 11** (⭐⭐) An welcher Stelle fällt der Graph aus Aufgabe 5 am
...
**Aufgabe 12** (⭐⭐) Der Graph von $f'$ ist eine nach oben geöffnete
...
**Aufgabe 13** (⭐) Ergänze die Faustregel: Der Graph einer
...
**Aufgabe 14** (⭐⭐) Fehlersuche: Lena zeichnet als $f'$-Graphen einfach
...
**Aufgabe 15** (⭐⭐⭐) Wende das Verfahren zweimal an: Der Graph von $f$
...
**Aufgabe 16** (⭐⭐⭐) Höhenprofil einer Radetappe: erst gleichmäßiger
