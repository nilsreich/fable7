...
**Aufgabe 1** (⭐) $f(x) = \dfrac{6}{x}$. Berechne $f(2)$, $f(12)$,
...
**Aufgabe 2** (⭐) Gib den maximalen Definitionsbereich an:
...
**Aufgabe 3** (⭐) Gib die Polstelle und die Gleichung der senkrechten
...
**Aufgabe 4** (⭐) Gib das Verhalten für $x \to +\infty$ in der
...
**Aufgabe 5** (⭐) Bestimme alle Nullstellen:
...
**Aufgabe 6** (⭐⭐) Ordne jedem Term das passende Asymptoten-Paar zu:
...
**Aufgabe 8** (⭐⭐) Bestimme die waagerechte Asymptote mit dem
...
**Aufgabe 9** (⭐⭐) $f(x) = \dfrac{1}{x-1}$ und $g(x) = \dfrac{1}{(x-1)^2}$
...
**Aufgabe 10** (⭐⭐) Löse die Bruchgleichungen (Definitionsbereich
...
**Aufgabe 11** (⭐⭐) Eine Funktion der Form $f(x) = \dfrac{a}{x-d} + c$
...
**Aufgabe 12** (⭐⭐) Fehlersuche: In einem Heft steht „$f(x) =
...
**Aufgabe 13** (⭐⭐) Untersuche rechnerisch auf Symmetrie:
...
**Aufgabe 14** (⭐⭐⭐) Ein Betrieb fertigt USB-Sticks mit Fixkosten 600 €
...
**Aufgabe 15** (⭐⭐⭐) Die Wirkung eines Medikaments in Abhängigkeit von
...
**Aufgabe 16** (⭐⭐⭐) $f(x) = \dfrac{2x^2}{x^2+1}$.
