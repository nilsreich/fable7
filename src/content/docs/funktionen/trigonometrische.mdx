...
**Aufgabe 1** (⭐) Rechne ins Bogenmaß um:
...
**Aufgabe 3** (⭐) Gib ohne Taschenrechner an:
...
**Aufgabe 4** (⭐) Gib für $f(x) = \sin(x)$ Wertebereich, Amplitude und
Periode an.
...
**Aufgabe 5** (⭐) Gib Amplitude und Wertebereich an:
...
**Aufgabe 6** (⭐⭐) Berechne die Periode:
...
**Aufgabe 7** (⭐⭐) $f(x) = 2\sin(x) + 3$. Gib Amplitude, Mittellinie und
Wertebereich an.
...
**Aufgabe 8** (⭐⭐) Im Amplituden-Vergleichsgraphen der Erklärung sind drei
...
**Aufgabe 9** (⭐⭐) $f(x) = 5\sin(2x) - 2$. Gib Wertebereich und Periode an.
...
**Aufgabe 10** (⭐⭐) Bestimme alle Lösungen in $[0;\ 2\pi]$:
a) $\sin(x) = 0$  b) $\cos(x) = 0$
...
**Aufgabe 11** (⭐⭐) Bestimme alle Lösungen von $\sin(x) = 0{,}5$ in
$[0;\ 2\pi]$.
...
**Aufgabe 12** (⭐⭐) Welche Symmetrie haben Sinus- und Kosinusfunktion?
...
**Aufgabe 13** (⭐⭐) Gib einen Funktionsterm an: Sinuskurve mit Amplitude 3,
...
**Aufgabe 14** (⭐⭐⭐) Beim Riesenrad aus Beispiel 3 wird die Gondel nach
...
**Aufgabe 15** (⭐⭐⭐) Der Kammerton $a^1$ ist eine Schwingung mit 440 Hz
...
**Aufgabe 16** (⭐⭐⭐) In einem Hafenbecken schwankt der Wasserstand durch
