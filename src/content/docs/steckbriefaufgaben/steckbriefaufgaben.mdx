...
**Aufgabe 1** (⭐) Übersetze in Gleichungen (Ansatz $f$ beliebig):
...
**Aufgabe 2** (⭐) Wie viele Bedingungen braucht man für eine
...
**Aufgabe 3** (⭐) Gib den passenden (verkürzten) Ansatz an:
...
**Aufgabe 4** (⭐) Wie viele Gleichungen liefert die Aussage „der Graph
...
**Aufgabe 5** (⭐⭐) Eine Parabel verläuft durch $(0 \mid 2)$,
...
**Aufgabe 6** (⭐⭐) Eine Parabel hat den Scheitel $S(1 \mid 4)$ und
...
**Aufgabe 7** (⭐⭐) Eine Parabel hat die Nullstellen 1 und 5 und
...
**Aufgabe 8** (⭐⭐) Eine Normalparabel-Verwandte $f(x) = x^2 + bx + c$
...
**Aufgabe 9** (⭐⭐) Eine ganzrationale Funktion dritten Grades ist
...
**Aufgabe 10** (⭐⭐) Grad 3, punktsymmetrisch zum Ursprung, Extremstelle
...
**Aufgabe 11** (⭐⭐⭐) Der abgebildete Graph gehört zu einer
...
**Aufgabe 12** (⭐⭐⭐) Gesucht ist eine Funktion dritten Grades mit
...
**Aufgabe 13** (⭐⭐) Grad 4, achsensymmetrisch, berührt die $x$-Achse
...
**Aufgabe 14** (⭐⭐⭐) Grad 4, achsensymmetrisch, Hochpunkt im Ursprung,
...
**Aufgabe 15** (⭐⭐) Weise nach, dass das Krankenstand-Modell
...
**Aufgabe 16** (⭐⭐⭐) Ein zweites Heim meldet: Krankenstand 5 % zu
...
**Aufgabe 17** (⭐⭐) Deute im Krankenstand-Modell (Beispiel 4) die
...
**Aufgabe 18** (⭐⭐) Eine Funktion dritten Grades verläuft durch
...
**Aufgabe 19** (⭐⭐⭐) Grad 4, achsensymmetrisch, Wendepunkt
...
**Aufgabe 20** (⭐⭐) Warum ist eine Parabel durch nur **zwei** Punkte
...
**Aufgabe 21** (⭐⭐) Eine Parabel geht durch $(1 \mid 4)$ und hat im
...
**Aufgabe 22** (⭐⭐⭐) Ein parabelförmiger Brückenbogen hat 40 m
...
**Aufgabe 23** (⭐⭐⭐) Löse das Gleichungssystem aus Aufgabe 18 und gib
...
**Aufgabe 24** (⭐⭐⭐) Eine Skateboard-Rampe soll bei $x = 0$ **glatt**
...
**Aufgabe 25** (⭐⭐⭐) Erkläre, warum es keine ganzrationale Funktion
