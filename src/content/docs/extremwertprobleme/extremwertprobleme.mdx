...
<summary>Verständnisfrage: Warum muss die Nebenbedingung eingesetzt werden, <em>bevor</em> abgeleitet wird?</summary>

Unsere Ableitungsregeln funktionieren nur für Funktionen **einer**
Variablen. $P = x \cdot y$ mit zwei freien Größen kann man nicht
sinnvoll ableiten – erst die Nebenbedingung $y = 20 - x$ macht daraus
$P(x) = x(20-x)$, eine gewöhnliche Funktion von $x$. Sie transportiert
außerdem die entscheidende Information: $x$ und $y$ sind nicht
unabhängig.
...
<details class="verstaendnis">
<summary>Verständnisfrage: Warum übersieht die Bedingung $f'(x) = 0$ Optima am Rand?</summary>

$f'(x_0) = 0$ sucht Stellen mit waagerechter Tangente – also Gipfel und
Täler **im Inneren**. Am Rand kann der größte Wert aber auch „im
Anstieg“ erreicht werden: Eine auf $[0;\ 5]$ streng steigende Funktion
hat ihr Maximum bei $x = 5$, obwohl die Ableitung dort nicht null ist.
Deshalb: Kandidaten aus $f' = 0$ **und** Randwerte vergleichen.
...
<details class="verstaendnis">
<summary>Verständnisfrage: „100 m Zaun, die eingezäunte Fläche soll möglichst groß werden“ – was ist hier Zielfunktion, was Nebenbedingung?</summary>

Die **Frage** nennt die Zielfunktion: Die *Fläche* $A = a \cdot b$ soll
maximal werden. Die **feste Vorgabe** ist die Nebenbedingung: Der
*Umfang* ist mit $2a + 2b = 100$ vorgegeben. Wer versehentlich den
Umfang ableitet, optimiert die Größe, die längst feststeht.
...
Zwei Zahlen haben die Summe 16. Für welche Zahlen ist
das Produkt maximal?
...
Zwei Zahlen haben die Summe 30. Wann ist die Summe
...
Ein Rechteck hat den Umfang 24 cm. Für welche Seiten
...
Benenne für Aufgabe 3 die Zielfunktion und die
Nebenbedingung.
...
Zaunproblem: 60 m Zaun, eine Seite ist eine Mauer.
...
Ein Rechteck soll den Flächeninhalt
...
Schachtelproblem mit einem Karton
...
Schachtelproblem mit Karton $20 \times 20$ cm (WTR
erlaubt).
...
Unter der Parabel $f(x) = 12 - x^2$ soll ein
...
In das Dreieck mit den Eckpunkten $(0 \mid 0)$,
...
Ein oben offener Kasten mit quadratischer
...
Für welche positive Zahl ist die Summe aus der
...
Das Produkt zweier positiver Zahlen ist 100. Wann
...
Ein rechteckiges Fenster soll den Umfang 6 m
...
Eine 400-m-Laufbahn besteht aus einem Rechteck
...
Der Gewinn eines Betriebs bei $x$ verkauften
...
Ein achsenparalleles Rechteck hat eine Ecke im
...
Welcher Punkt der Normalparabel $y = x^2$ liegt
...
Formuliere die 5 Schritte des Lösungsverfahrens
...
Aus 36 cm Draht wird ein Rechteck gebogen. Stelle
...
Ein 40 cm langer Draht wird in zwei Stücke
...
Aus einem 40 cm breiten Blechstreifen wird eine
...
Ein Plakat soll $600\ \text{cm}^2$ groß sein, mit
...
Bei einem Quader mit quadratischer Grundfläche
...
Ein Ausflugsboot fährt bei 20 € Fahrpreis mit 60
...
Beim Zaunproblem $A(x) = x(60 - 2x)$ aus
...
<details class="aufgabe">
<summary>Aufgabe 31 ⭐</summary>

Warum minimiert man in Aufgabe 22 das **Quadrat**
...
<details class="aufgabe">
<summary>Aufgabe 32 ⭐⭐</summary>

Erkläre am Beispiel von Aufgabe 25 b), warum man
...
<details class="aufgabe">
<summary>Aufgabe 33 ⭐⭐⭐</summary>

Eine Getränkedose soll 330 ml fassen. Berechne
...
<details class="aufgabe">
<summary>Aufgabe 34 ⭐⭐</summary>

Zeige allgemein: Unter allen Rechtecken mit
...
<details class="aufgabe">
<summary>Aufgabe 35 ⭐⭐⭐</summary>

Zeige allgemein: Bei der geschlossenen Dose mit
...
<details class="aufgabe">
<summary>Aufgabe 36 ⭐⭐ · Verständnisaufgabe</summary>

a) Finde den Fehler: „100 m Zaun, maximale Rechteckfläche: Ich leite den
Umfang $U = 2a + 2b$ ab und setze ihn null.“
b) Wahr oder falsch? „Wenn $P'(x_0) = 0$ und $P''(x_0) < 0$ gilt, ist
$x_0$ automatisch die Antwort auf die Sachfrage.“

<details>
<summary>Lösung zu Aufgabe 36</summary>

a) Hier wird die **falsche Größe** optimiert: Der Umfang steht mit
100 m längst fest – er ist die Nebenbedingung. Maximal werden soll die
**Fläche**: Zielfunktion $A = a \cdot b$, Nebenbedingung
$b = 50 - a$ einsetzen, dann $A(a) = a(50 - a)$ ableiten.

b) **Falsch.** Damit ist $x_0$ nur ein **lokales Maximum** der
Zielfunktion. Für die Antwort fehlen drei Prüfungen: Liegt $x_0$
überhaupt im sinnvollen Definitionsbereich? Ist der Wert größer als die
**Randwerte**? Und was war eigentlich gefragt – oft will die Aufgabe
noch die zweite Größe oder den optimalen Wert selbst wissen
(Antwortsatz mit Einheiten!).
...
<Quiz fragen={[
  { frage: 'Was ist die Zielfunktion eines Extremwertproblems?',
    antworten: ['Der feste Zusammenhang zwischen den Variablen', 'Die Größe, die maximal oder minimal werden soll', 'Immer der Flächeninhalt', 'Die Ableitung'],
    richtig: 1, erklaerung: 'Die Zielfunktion ist die Größe aus der Frage („… soll maximal werden“); der feste Zusammenhang ist die Nebenbedingung.' },
  { frage: 'Wozu dient die Nebenbedingung?',
    antworten: ['Sie liefert die y-Koordinate', 'Sie eliminiert eine Variable aus der Zielfunktion', 'Sie prüft das Ergebnis', 'Sie ist optional'],
    richtig: 1, erklaerung: 'Nach einer Variablen auflösen und einsetzen – erst dann hat die Zielfunktion nur noch eine Variable und kann abgeleitet werden.' },
  { frage: 'Zwei Zahlen haben die Summe 20. Wann ist ihr Produkt maximal?',
    antworten: ['Bei 5 und 15', 'Bei 10 und 10', 'Bei 1 und 19', 'Bei 20 und 0'],
    richtig: 1, erklaerung: 'P(x) = x(20 − x) hat das Maximum bei x = 10: Produkt 100.' },
  { frage: 'Welches Rechteck mit festem Umfang hat die größte Fläche?',
    antworten: ['Ein möglichst langes', 'Das Quadrat', 'Eines mit Seitenverhältnis 2:1', 'Alle sind gleich groß'],
    richtig: 1, erklaerung: 'Die Rechnung führt immer auf gleiche Seitenlängen – das Quadrat gewinnt.' },
  { frage: 'Warum muss man die Randwerte des Definitionsbereichs prüfen?',
    antworten: ['Weil die Ableitung dort falsch ist', 'Weil das Optimum am Rand liegen kann, wo f′ nicht null ist', 'Aus Höflichkeit', 'Nur bei Minima nötig'],
    richtig: 1, erklaerung: 'f′ = 0 findet nur innere Kandidaten – auf einem Intervall kann der beste Wert am Rand sitzen.' },
  { frage: 'Schachtelproblem mit 12-cm-Karton: Welcher Definitionsbereich ist sinnvoll für V(x) = x(12 − 2x)²?',
    antworten: ['x &gt; 0', '0 &lt; x &lt; 12', '0 &lt; x &lt; 6', 'x beliebig'],
    richtig: 2, erklaerung: 'Bei x = 6 wäre die Grundfläche 12 − 2·6 = 0 – mehr als die halbe Seitenlänge kann man nicht einschneiden.' },
  { frage: 'Welche Form hat die materialsparendste geschlossene Dose mit festem Volumen?',
    antworten: ['Möglichst flach', 'Möglichst hoch und schmal', 'Höhe = Durchmesser (h = 2r)', 'Höhe = Radius'],
    richtig: 2, erklaerung: 'Die Optimierung liefert h = 2r – die Dose ist „so hoch wie breit“, unabhängig vom Volumen.' },
  { frage: 'Warum darf man statt des Abstands das Abstandsquadrat minimieren?',
    antworten: ['Weil es dasselbe Ergebnis mit einfacherer Rechnung liefert', 'Weil der Abstand nie minimal wird', 'Darf man nicht', 'Weil Quadrate immer kleiner sind'],
    richtig: 0, erklaerung: 'Quadrieren ist für nichtnegative Zahlen monoton – Minimum an derselben Stelle, aber ohne störende Wurzel im Term.' },
  { frage: 'Verständnisfrage: Warum kann man die Zielfunktion P = x · y nicht direkt ableiten?',
    antworten: ['Weil Produkte nicht abgeleitet werden können', 'Weil sie noch zwei unabhängige Variablen enthält – erst die Nebenbedingung macht daraus eine Funktion einer Variablen', 'Weil P zu groß werden kann', 'Man kann: P′ = y'],
    richtig: 1, erklaerung: 'Unsere Ableitungsregeln gelten für Funktionen einer Variablen. Die Nebenbedingung (z. B. y = 20 − x) eliminiert die zweite Größe.' },
  { frage: 'Verständnisfrage: Die Zielfunktion ist auf [0; 5] streng steigend. Wo liegt das Maximum?',
    antworten: ['Nirgends – f′ wird nie null', 'Bei x = 0', 'Am rechten Rand x = 5, obwohl dort f′ ≠ 0 ist', 'In der Intervallmitte'],
    richtig: 2, erklaerung: 'f′ = 0 findet nur innere Gipfel. Auf einem Intervall kann das Optimum am Rand sitzen – deshalb gehören Randwerte immer zur Kontrolle.' },
]} />
